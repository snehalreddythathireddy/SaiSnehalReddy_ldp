...
export const candidates: Candidate[] = [
  ...
  { id: 6, name: "Erastus", adjudication: "-", status: "CLEAR", location: "Höviyin Am", date: "12/1/2021" },
  { id: 7, name: "Jereme", adjudication: "-", status: "CONSIDER", location: "Shāringol", date: "7/26/2022" },
