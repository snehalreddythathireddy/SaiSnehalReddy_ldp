...
// Header (organisms)
export const HEADER_TITLE = "Candidates";
export const HEADER_EXPORT_LABEL = "Export";
export const HEADER_MANUAL_ORDER_LABEL = "Manual Order";

// Sidebar
export const SIDEBAR_LOGO_TEXT = "RECRUIT";
export const SIDEBAR_USER_NAME = "James Rodriguez";
export const SIDEBAR_USER_HANDLE = "James.co";
export const SIDEBAR_LOGOUT_ALT = "Logout";

// TableHeader
export const TABLE_HEADERS = ["NAME", "ADJUDICATION", "STATUS", "LOCATION", "DATE"];
